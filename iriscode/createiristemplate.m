...
%addpath("Segmentation") %added by Daksh
%addpath("Normal_encoding") %added by Daksh
...
nscales=2; %changed from 1
minWaveLength=12; %changed from 18
mult=1; % not applicable if using nscales = 1 %changed from 1
sigmaOnf=.3; %changed from 0.5 to 0.3
